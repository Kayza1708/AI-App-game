...
export const COMPONENTS=Object.freeze([
  {id:'circuits',name:'Circuits',rarity:'Common',icon:'▦',description:'Reliable control boards recovered from scaled hardware.',sources:['Own 10 Calculators','Complete Blueprint Analysis']},
  {id:'lasers',name:'Lasers',rarity:'Uncommon',icon:'✦',description:'Precision photonics for fast model accelerators.',sources:['Own a Workstation','Complete Material Analysis']},
  {id:'graphene',name:'Graphene',rarity:'Rare',icon:'◇',description:'Conductive sheets for efficient memory and cooling.',sources:['Complete Material Analysis','Crafting milestone: first item']},
  {id:'titanium-screws',name:'Titanium Screws',rarity:'Common',icon:'⌘',description:'Durable fasteners recovered during fleet maintenance.',sources:['Own 25 total Hardware','Complete Blueprint Analysis']},
