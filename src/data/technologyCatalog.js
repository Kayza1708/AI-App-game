...
export const TECHNOLOGY_BRANCHES = Object.freeze({
  ...
  automation:B('Autonomous Company','automation','#9da9ff',100,[
    ...
    N('Auto Revenue','major','marketing',.20,'Automatically optimizes User revenue.',{mechanic:'auto-marketing'}),
  ...
  market:B('Market & Marketing','market','#ffcb66',1,[
    N('Revenue Analytics','minor','marketing',.85,'Improves Credits generated by each User.'),
