...
export const EVENT_CATEGORIES = ['session','run','purchase','progression','decision','economy','active-play','world','ui','developer','funnel','feature','balance','patent','collection','build','currency','retention','research'];
