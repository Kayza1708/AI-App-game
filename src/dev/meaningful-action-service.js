const MEANINGFUL_TYPES = new Set(['hardware-purchased','energy-generator-purchased','run-upgrade-purchased','model-improvement-purchased','model-unlocked-permanently','model-training-target-changed','intelligence-node-purchased','gem-shop-purchase','model-training-started','model-training-completed','model-deployed','model-undeployed','objective-claimed','achievement-unlocked','mission-claimed','patent-discovered','world-event-choice-selected','rewarded-boost-activated','development-cycle-performed','hardware-milestone-reached']);
