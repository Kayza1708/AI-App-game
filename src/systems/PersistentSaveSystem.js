...
function normalizeResearchUpgradeLevels(save){const explicit=readSaveNumericMap(save.researchUpgradeLevels);for(const id of readSaveArray(save.upgrades))if(id.startsWith('research-'))explicit[id]=Math.max(1,explicit[id]??0);return explicit}
